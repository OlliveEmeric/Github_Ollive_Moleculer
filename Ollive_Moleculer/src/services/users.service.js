...
module.exports = {
	...
	actions: {
		...
		//	call "users.create" --email "e-mail" --prenom "nom" --nom "nom" --channel 0
		create: {
			params: {
				email: "string",
				prenom: "string",
		...
		//	call "users.edit" --email "e-mail" --prenom "prenom" --nom "nom"
		edit: {
			params: {
				email: "string",
				prenom: "string",
						...
						.then((db_user) => {
							return Database()
								.then((db) => {
									...
									user.prenom = ctx.params.prenom || db_user.prenom;
									user.nom = ctx.params.nom || db_user.nom;
